...
public:
    ...
    Main()
    {
        ...
        m_directionalLight.AmbientIntensity = 0.1f;//-0.1f
        m_directionalLight.DiffuseIntensity = 0.0f;//рассеивание
    ...
    bool Init()
    {
        ...
        m_pTexture = new Texture(GL_TEXTURE_2D, "D:/labs/Graphics/lab3.20/car.png");
