...
public:
    ...
    Main()
    {
        ...
        m_directionalLight.AmbientIntensity = 1.0f;//0.0f
        m_directionalLight.DiffuseIntensity = 0.75f;
        m_directionalLight.Direction = Vector3f(0.0f, 1.0, 0.0);//1.0f, 0.0, 0.0
    }
    ...
    bool Init()
    {
        ...
        m_pTexture = new Texture(GL_TEXTURE_2D, "D:/labs/Graphics/lab3.18/car.png");
